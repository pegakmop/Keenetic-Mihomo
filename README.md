...
Для более полноценной работы ядра Михомо, в том числе и работы с TCP и UDP желательно включить режим TUN. На моем роутере Kenetic Hopper SE он есть, но пока не удалось полноценно перенаправить трафик в него.
