...
Для более гармоничной работы ядра Михомо желательно включить режим TUN. На моем роутере Kenetic Hopper SE он есть, но пока не удалось полноценно перенаправить трафик в него.
